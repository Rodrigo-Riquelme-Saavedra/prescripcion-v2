...
function Prescripcion({ onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Courier New', monospace", color: C.text }}>
      <div style={{ background: "#1e1e1e", borderBottom: "3px solid #8b1a2e", padding: "0 32px", height: 70, display: "flex", alignItems: "center", gap: 18 }}>
        <img src="https://raw.githubusercontent.com/Rodrigo-Riquelme-Saavedra/prescripcion-v2/main/public/PaginaWeb.png" alt="Grupo GV" style={{ height: 52, objectFit: "contain" }} onError={(e) => { e.target.style.display = "none"; }} />
        <div style={{ width: 1, height: 36, background: "linear-gradient(to bottom, transparent, #8b1a2e, transparent)" }} />
        <div>
          <div style={{ fontWeight: 700, fontSize: 13, letterSpacing: 2, color: "#f4f4f4" }}>SISTEMA DE PRESCRIPCIÓN TRIBUTARIA</div>
          <div style={{ fontSize: 10, color: "#b52240", letterSpacing: 2, marginTop: 2 }}>Art. 201 Código Tributario · Grupo GV</div>
        </div>
        <button onClick={onBack} style={{ marginLeft: "auto", background: "rgba(139,26,46,0.1)", border: "1px solid #8b1a2e", borderRadius: 4, padding: "6px 16px", fontSize: 11, color: "#b52240", fontWeight: 700, cursor: "pointer", fontFamily: "inherit", letterSpacing: 1 }}>← Volver al Portal</button>
      </div>
